...
namespace Xpressive.Home.ProofOfConcept.Gateways.Daylight
{
    ...
    internal static class SunsetCalculator
    {
        ...
        {
            return GetSunrise(System.DateTime.Now.Date, latitude, longitude);
        }

        public static TimeSpan GetSunrise(System.DateTime date, double latitude, double longitude)
        {
            date = date.Date;
            var jd = CalcJd(date);
        ...
        {
            return GetSunset(System.DateTime.Now.Date, latitude, longitude);
        }

        public static TimeSpan GetSunset(System.DateTime date, double latitude, double longitude)
        {
            date = date.Date;
            var jd = CalcJd(date);
        ...
        private static double CalcJd(System.DateTime date)
        {
        ...
        private static System.DateTime? GetDateTime(double minutes, System.DateTime date)
        {
            if ((minutes >= 0) && (minutes < 1440))
            {
                ...
                return new System.DateTime(date.Year, date.Month, date.Day, (int)hour, (int)minute, (int)second);
            }
            return null;
        }
    }
