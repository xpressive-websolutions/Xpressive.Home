...
namespace Xpressive.Home.Automation
{
    internal class RecurrentScriptJobFactory : IJobFactory
    {
        ...
        public RecurrentScriptJobFactory(IScheduledScriptRepository repository, IList<IScriptObjectProvider> scriptObjectProviders, IScriptRepository scriptRepository)
        {
